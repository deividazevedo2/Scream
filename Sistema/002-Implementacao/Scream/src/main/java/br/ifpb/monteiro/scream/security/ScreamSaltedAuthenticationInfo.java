...
public class ScreamSaltedAuthenticationInfo implements SaltedAuthenticationInfo {
	  ...
	  public ScreamSaltedAuthenticationInfo(String username, String password, String salt) {
